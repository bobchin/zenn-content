...
- エンドポイントディスクリプタ(7byte)
  ...
  | wMaxPacketSize   | Bitmap         |   1    | エンドポイントの最大パケットサイズ | 0x0008      |
  ...
  - bmAttribute
    ...
    | :-- | :----------------------------------- | :--------------------------------------------------------------------------------------------------------------- |
    | 7-6 | 予約                                 | 0(固定)                                                                                                          |
    | 5-4 | 使用タイプ（アイソクロナス転送のみ） | 00: データエンドポイント, 01: フィードバックエンドポイント, 10: インプリシットフィードバックデータエンドポイント |
    | 3-2 | 同期タイプ（アイソクロナス転送のみ） | 00: 同期無し, 01: 非同期, 10: Adaptive, 11: 同期                                                                 |
    | 1-0 | 転送タイプ                           | 00:コントロール, 01: アイソクロナス, 10: バルク, 11: インタラプト                                                |
